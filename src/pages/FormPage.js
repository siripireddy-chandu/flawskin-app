    ...
    const [formData, setFormData] = useState({
      ...
      useEffect(() => {
        ...
        if (serviceType === 'Trailsession') {
          ...
          options = ['Full Body 5 Body Parts', 'Full Body 5 Body Parts sessions - 3', 'Full Body 5 Body Parts sessions - 6','Full Body 8 Body Parts','Full Body 8 Body Parts sessions - 3','Full Body 8 Body Parts sessions - 6',];
        } else if (serviceType === 'Face') {
          options = ['Upper Lip', 'Chin', 'Upper Neck','Side Lock','Cheeks','Full Face'];
        }
          ...
          options = ['Full Legs + Hands + Underarms','Full Legs + Underarms + Bikini','Full Face + Underarms','Bikini + Buttocks','Full Face + Bikini','Full Front + Full Back','Full Hands + Underarms','Full Hands + Full Legs',];
        }
