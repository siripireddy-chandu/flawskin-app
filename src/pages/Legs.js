      ...
      <div className="container col-xl-9">
        <div className="row  widget-content-area bg-light rounded p-4 mt-4">
          ...
          <div className="col-md-11">
            <h5 className="text-primary">Legs Laser Hair Reduction</h5>
            <h5 className="text-dark text" style={{ fontSize: "14px" }}>
            Get smooth, hair-free skin on your Legs with our safe and effective laser hair removal treatments.
            </h5>
            ...
            <div className="container col-xl-9">
              ...
              >
                ...
                <p>
                  ...
                  <img
                    src="assets\assets\img\LEGS (1).png"
                    alt="Time icon"
                    style={{
                      width: "50px",
                      borderRadius: "20px",
                ...
                <div className="col-6  col-xl-4">
                  <a href="https://rzp.io/l/0VJMhu0gys">
                ...
                <div className="col-6 col-xl-4 ">
                  <button
                    ...
                    onClick={() => navigate("/form", { state: { serviceType: "Legs" } })}
                  >
                    <img
