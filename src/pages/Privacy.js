    ...
    <div>
      ...
      <section className="about-us py-5 bg-light">
        <div className="container">
          ...
          <h2 className="text-primary mb-4">ONLINE STORE TERMS</h2>
          <p>
          ...
          <h2 className="text-primary mb-4">GENERAL CONDITIONS</h2>
          ...
          <h2 className="text-primary mb-4">ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h2>
          <p>
          ...
          <h2 className="text-primary mb-4">MODIFICATIONS TO THE SERVICE AND PRICES</h2>
          <p>
          ...
          <h2 className="text-primary mb-4">PRODUCTS OR SERVICES</h2>
          <p>
          ...
          <h2 className="text-primary mb-4">OPTIONAL TOOLS</h2>
          <p>
          ...
          <h2 className="text-primary mb-4">THIRD-PARTY LINKS</h2>
          <p>
          ...
          <h2 className="text-primary mb-4">USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h2>
          ...
          <h2 className="text-primary mb-4">ERRORS, INACCURACIES AND OMISSIONS</h2>
          ...
          <h2 className="text-primary mb-4">PROHIBITED USES</h2>

          <p>
            In addition to other prohibitions as set forth in the Terms of Service, you are prohibited from using the site or its content: (a) for any unlawful purpose; (b) to solicit others to perform or participate in any unlawful acts; (c) to violate any international, federal, provincial or state
          ...
          <h2 className="text-primary mb-4">DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h2>
          ...
          <p>
            ...
            In no case shall FLAWSKIN PRIVATE LIMITED, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted,
          ...
          <h2 className="text-primary mb-4">INDEMNIFICATION</h2>
          <p>
          ...
          <h2 className="text-primary mb-4">SEVERABILITY</h2>
          <p>
            In the event that any provision of these Terms of Service is determined to be unlawful, void or unenforceable, such provision shall nonetheless be enforceable to the fullest extent permitted by applicable law, and the unenforceable portion shall be deemed to be severed from these Terms of Service, such determination shall not affect the validity and enforceability of any other remaining provisions.
          </p>

          <h2 className="text-primary mb-4">TERMINATION</h2>
          ...
          <h2 className="text-primary mb-4">ENTIRE AGREEMENT</h2>
          ...
          <h2 className="text-primary mb-4">GOVERNING LAW</h2>

          <p> These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of India and jurisdiction of Bangalore, Karnataka.</p>

          <h2 className="text-primary mb-4">CHANGES TO TERMS OF SERVICE</h2>

          <p>

            You can review the most current version of the Terms of Service at any time at this page.
            We reserve the right, at our sole discretion, to update, change or replace any part of these Terms of Service by posting updates and changes to our website. It is your responsibility to
            check our website periodically for changes. Your continued use of or access to our website or the Service following the posting of any changes to these Terms of Service constitutes acceptance of those changes.
          </p>
          ...
          <p>
            <strong>
              ...
              <a href="mailto:contact@flawskin.com" className="text-primary"> contact@flawskin.com</a>.
            </strong>
          </p>
